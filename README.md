...
* [readwise-skills](https://github.com/readwiseio/readwise-skills) ⭐ 306 | 🐛 5 | 🌐 Python | 📅 2026-06-19 - The official agent skills from RW.
...
* [readwise-cli](https://github.com/readwiseio/readwise-cli) ⭐ 73 | 🐛 5 | 🌐 TypeScript | 📅 2026-08-27 - The official RW CLI.
...
* [readwise-mcp-http-server](https://github.com/CaseyRo/readwise-mcp-http-server) ⭐ 1 | 🐛 13 | 🌐 Python | 📅 2026-09-07 - A Node.js HTTP server that provides proper MCP over HTTP.
...
* [readwise-reader](https://github.com/raycast/extensions/tree/main/extensions/readwise-reader) ⭐ 7,741 | 🐛 1,565 | 🌐 TypeScript | 📅 2026-09-12 - extension to interact with Reader.
* [readwise](https://github.com/raycast/extensions/tree/main/extensions/readwise) ⭐ 7,741 | 🐛 1,565 | 🌐 TypeScript | 📅 2026-09-12 - extension to interact with Readwise.
