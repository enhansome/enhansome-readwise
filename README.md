...
* [readwise-skills](https://github.com/readwiseio/readwise-skills) ⭐ 296 | 🐛 5 | 🌐 Python | 📅 2026-06-19 - The official agent skills from RW.
...
* [readwise-mcp](https://github.com/readwiseio/readwise-mcp) ⭐ 153 | 🐛 6 | 🌐 JavaScript | 📅 2026-03-14 - The official RW MCP (Deprecated)
...
* [readwise-cli](https://github.com/readwiseio/readwise-cli) ⭐ 68 | 🐛 7 | 🌐 TypeScript | 📅 2026-07-09 - The official RW CLI.
...
* [readwise-mcp-http-server](https://github.com/CaseyRo/readwise-mcp-http-server) ⭐ 1 | 🐛 13 | 🌐 Python | 📅 2026-08-05 - A Node.js HTTP server that provides proper MCP over HTTP.
...
* [readwise-to-datasette](https://github.com/iloveitaly/readwise-to-datasette) ⭐ 9 | 🐛 0 | 🌐 Python | 📅 2026-08-03 - Extract Readwise highlights into a Datasette SQLite database.
...
* [logseq-readwise-plugin](https://github.com/hkgnp/logseq-readwise-plugin) ⭐ 65 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-03 - Pull Readwise highlights into Logseq.
...
* [readwise-reader](https://github.com/raycast/extensions/tree/main/extensions/readwise-reader) ⭐ 7,686 | 🐛 1,543 | 🌐 TypeScript | 📅 2026-08-14 - extension to interact with Reader.
* [readwise](https://github.com/raycast/extensions/tree/main/extensions/readwise) ⭐ 7,686 | 🐛 1,543 | 🌐 TypeScript | 📅 2026-08-14 - extension to interact with Readwise.
...
* [readwise2directory](https://github.com/nicrivard/readwise2directory) ⭐ 77 | 🐛 2 | 🌐 Python | 📅 2022-06-11 - Update and store highlights locally (in markdown).
